...
public class AliyunSendPhoneUtil {
    ...
    //注：有备注无需修改的位置请勿改动。
    private static SendSmsResponse sendPhoneCode(String phoneNumbers, String signName, String templateCode, String templateParam) throws ClientException, com.aliyuncs.exceptions.ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4FwiWCxLFQdhoEFPsZpm";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "Y65UJKLkurKCaD0SWRytk2HEuB3oEr";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String sendCode(String phones,String code){
        ...
        String signName="黑子的开发";  //签名
        String templateCode="SMS_186943835";  //模板
    ...
    public static void main(String[] args) {
        ...
        String message = sendCode(phones, "iloveu");
