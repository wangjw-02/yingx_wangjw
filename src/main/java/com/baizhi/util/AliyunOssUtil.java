...
public class AliyunOssUtil {
    ...
    private static String accessKeyId = "LTAI4FwiWCxLFQdhoEFPsZpm";
    private static String accessKeySecret = "Y65UJKLkurKCaD0SWRytk2HEuB3oEr";
    /**
     * 存储空间名
     */
    private static String bucket="yingx-wangjw";
